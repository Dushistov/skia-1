...
SK_API void sk_paint_set_text_size(sk_paint_t *paint, float ts);
SK_API float sk_paint_get_text_size(sk_paint_t *paint);
SK_API void sk_paint_measure_text(const sk_paint_t *paint, const char *text, size_t text_len, sk_rect_t *bounds);
SK_API float sk_paint_get_font_spacing(const sk_paint_t *paint);
SK_API void sk_paint_set_dash_effect(sk_paint_t *paint, float value1, float value2);
SK_API void sk_paint_reset_dash_effect(sk_paint_t *paint);
